...
import { TodoEntity, TodoValidationError, TodoNotFoundError } from "../domain/todo.entity"

describe("V2 Hexagonal — TodoEntity (unit)", () => {
    const makeTodo = (overrides?: Partial<ConstructorParameters<typeof TodoEntity>>) => {
