...
import { TodoEntity, TodoNotFoundError, TodoValidationError } from "@/modules/todo/domain/todo.entity"
...
export class TodoController {
    ...
    registerRoutes() {
        return new Elysia({ name: "Todo.V2.Module", prefix: "/v2/todo" })
            ...
            .guard({ as: "local" }, (app) =>
                app
                    ...
                    .patch("/:id", async ({ session, params, body }) => {
